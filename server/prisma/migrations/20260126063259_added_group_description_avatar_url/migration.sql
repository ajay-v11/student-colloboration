/*
  ...
  - Added the required column `groupIconUrl` to the `Group` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "Group" ADD COLUMN     "description" TEXT NOT NULL,
ADD COLUMN     "groupIconUrl" TEXT NOT NULL,
